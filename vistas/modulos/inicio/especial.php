            ...
            <div class="box-body">
              ...
              <ul class="todo-list">
                <li>
                  ...
                  <!-- todo text -->
                  <span class="text">Diseñar un tema</span>
                  <!-- Emphasis label -->
                ...
                <li>
                  ...
                  <input type="checkbox" value="">
                  <span class="text">Hacer el tema responsivo</span>
                ...
                <li>
                  ...
                  <input type="checkbox" value="">
                  <span class="text">Deja que el tema brille con unan estrella</span>
                ...
                <li>
                  ...
                  <input type="checkbox" value="">
                  <span class="text">Revisar cada boton del tema</span>
